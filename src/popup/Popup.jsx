...
const Popup = () => {
  ...
  return (
    <div className="flex flex-col gap-4 p-4 justify-center bg-gradient-to-b from-white via-cyan-200 to-blue-100 min-h-screen">
      ...
      {/* Status area */}
      <div className="text-center text-sm text-gray-700 min-h-[1.5rem]">
        {status}
      </div>
